...
export default function EnhancingEcaPage() {
  const [activeModalImg, setActiveModalImg] = useState(null);

  const { data: ecaData, loading } = usePublicData(
    () => publicApi.eca("Enhancing ECA"),
    []
  );
  ...
  return (
    <>
      <PageBanner
        ...
        title="Enhancing Extra-Curricular Activities (ECA)"
      ...
      <section className="shell partners-page-layout">
        <div className="partners-container">
          <EcaSidebar currentPage="enhancing-eca" />

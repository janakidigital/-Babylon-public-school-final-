...
export default function BecomeTeacherPage() {
  ...
  return (
    <>
      ...
      {/* ===================== LAYOUT WITH SIDEBAR ===================== */}
      <div className="admissions-page-layout">
        <div className="admissions-container">
          {/* Sidebar */}
          <AdmissionsSidebar currentPage="career" />

          {/* Main Content */}
          <div className="admissions-main-content">
            {/* ===================== OPEN ROLES ===================== */}
            <section className="shell" style={{ padding: "0 0 2rem" }}>
              ...
              {loading ? (
                ...
                <p style={{ marginTop: "1rem" }}>
                  There are no current vacancies. We are always interested in
                  meeting thoughtful educators — share your interest below.
                </p>
              )}
            </section>
            ...
            <section className="career-page shell" style={{ paddingTop: "2rem" }}>
              <div>
                ...
                <p>
                  We look for energetic educators committed to helping young
                  people flourish at Babylon National School.
                </p>
                <ul>
              ...
              <form onSubmit={submit} encType="multipart/form-data">
                ...
                <label>
                  ...
                  />
                  <small
                    style={{ display: "block", marginTop: "6px", color: "#666" }}
                  >

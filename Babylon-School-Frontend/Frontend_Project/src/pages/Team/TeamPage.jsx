...
export default function TeamPage() {
  ...
  const filteredTeachers = useMemo(() => {
    return (teachers || []).filter((teacher) => {
      ...
      if (selectedCategory !== "ALL") {
        const teacherCat = String(teacher.category || "").trim().toUpperCase();
        if (teacherCat) {
      ...
      if (searchQuery.trim()) {
        ...
        const matchesDesig = (teacher.designation || "").toLowerCase().includes(q);
        const matchesDept = (teacher.department || "").toLowerCase().includes(q);
  ...
  return (
    <>
      ...
      <section className="listing-page shell team-page-section">
          ...
          {TEAM_CATEGORIES.map((cat) => {
            ...
            return (
              <button
                ...
                style={{
                  background: isActive ? "#00acc1" : "#ffffff",
                  ...
                  cursor: "pointer",
                  boxShadow: isActive
                    ? "0 4px 12px rgba(0, 172, 193, 0.35)"
        ...
        >
          {ALPHABETS.map((letter) => {
            ...
            const hasMembers = letter === "ALL" || availableLetters.has(letter);
            ...
            return (
              <button
                ...
                style={{
                  ...
                  background: isActive ? "#c53030" : "#f1f5f9",
                  color: isActive ? "#ffffff" : hasMembers ? "#c53030" : "#a0aec0",
                  border: "none",
                  fontSize: "13px",
                  fontWeight: 700,
                  cursor: "pointer",
                ...
                onMouseLeave={(e) => {
                  if (!isActive) {
                    ...
                    e.currentTarget.style.color = hasMembers ? "#c53030" : "#a0aec0";
                  }
                }}
              >
                {letter}
